...
export class AjaxWaitInterceptor implements HttpInterceptor {
    ...
    intercept(
        ...
        this.srv.Mostrar();
        return next.handle(req).pipe(finalize(() => this.srv.Ocultar()));
    }
}
// versión standalone
// withInterceptors([ ajaxWaitInterceptor ])
export function ajaxWaitInterceptor(
...
export class AjaxWaitComponent {
    ...
    public get Visible() {
        return this.srv.Visible;
    }
    public get Oculto() {
        return this.srv.Oculto;
    }
}
