...
import { Languages_COMPONENTES, LanguagesViewModelService } from './componente.component';
...
describe('Modulo Languages', () => {
  const apiURL = environment.apiUrl + 'catalogo/Languages/v1'
  const dataMock = [
  ...
  describe('DAOService', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [],
        providers: [LanguagesDAOService, provideHttpClient(), provideHttpClientTesting()],
      });
    });

    it('query', inject([LanguagesDAOService, HttpTestingController], (dao: LanguagesDAOService, httpMock: HttpTestingController) => {
      dao.query().subscribe({
          next: data => {
    ...
    it('get', inject([LanguagesDAOService, HttpTestingController], (dao: LanguagesDAOService, httpMock: HttpTestingController) => {
      dao.get(1).subscribe({
          next: data => {
    ...
    it('add', inject([LanguagesDAOService, HttpTestingController], (dao: LanguagesDAOService, httpMock: HttpTestingController) => {
    ...
    it('change', inject([LanguagesDAOService, HttpTestingController], (dao: LanguagesDAOService, httpMock: HttpTestingController) => {
    ...
    it('delete', inject([LanguagesDAOService, HttpTestingController], (dao: LanguagesDAOService, httpMock: HttpTestingController) => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [NotificationService, LoggerService,
          ...
          { provide: LanguagesDAOService, useFactory: () => new DAOServiceMock<Idioma, number>([...dataMock]) }
        ],
      });
      service = TestBed.inject(LanguagesViewModelService);
      dao = TestBed.inject(LanguagesDAOService);
    });
  ...
  describe('Componentes', () => {
    Languages_COMPONENTES.forEach(componente => {
      describe(componente.name, () => {
        ...
        beforeEach(async () => {
          await TestBed.configureTestingModule({
                providers: [NotificationService, LoggerService, LanguagesViewModelService,
                  provideHttpClient(), provideHttpClientTesting(),
                  provideRouter([]), provideLocationMocks()],
        ...
        beforeEach(() => {
          const vm = TestBed.inject(LanguagesViewModelService)
          vm.add()
